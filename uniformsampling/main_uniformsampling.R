...
# main_uniformsampling.R

# This script is almost the same as "main.R", with some modifications
# to make it use only a single uniform sampling rate instead of the six
# empirically-derived sampling models. It calls "functions_uniformsampling.R".
...
source("functions_uniformsampling.R")   # For all custom functions
